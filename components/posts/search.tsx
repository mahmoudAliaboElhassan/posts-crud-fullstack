    ...
    <div className="w-full max-w-4xl mx-auto px-4">
      <div className="relative">
        <input
          ...
          className="w-full px-6 py-4 pr-16 text-lg bg-white dark:bg-zinc-800 border-2 border-zinc-300 dark:border-zinc-600 rounded-xl focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 transition-colors shadow-lg"
        />
        <button
